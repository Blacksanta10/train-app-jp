...
line_metadata = {
    ...
    'Keio Inokashira' : {'code_letter': 'IN', 'color': "#0D197E", 'owner': 'Keio Corp'},
...
## Keio Railways
    ...
    ['Shimo-Takaido','下高井戸','Keio Line','07',1],
    ['Sakurajosui','桜上水','Keio Line','08',0],
    ...
    ['Tamasakai', '多摩境','Keio Sagamihara', '44', 1],
...
# Other important --------------------------------------------------------
    ...
    ['Tsudanuma','津田沼','Chuo Sobu','33',1],
    ['Makuharihongo','幕張本郷','Chuo Sobu','34',1],
    ['Makuhari','幕張','Chuo Sobu','35',1],
    ['Shin-kemigawa','新検見川','Chuo Sobu','36',0],
    ['Inage','稲毛','Chuo Sobu','37',0],
    ['Nishi-chiba','西千葉','Chuo Sobu','38',0],
    ['Chiba','千葉','Chuo Sobu','39',1],
